...
using DEService.DESParameters, DEService.DESState, DEService.DESRoutingFunctions

import Base: isless

export Event, TimedEvent, process_event, EndSimEvent, ExternalArrivalEvent, JoinNodeEvent, ServiceCompleteEvent, join_node
