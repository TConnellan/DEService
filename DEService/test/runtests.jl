...
# !!! Main.UserApp is configured as an alias for Main.DEService and you might encounter it in some tests
using Main.DEService, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "DEService tests" begin
  @includetests ARGS
end
